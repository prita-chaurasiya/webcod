...
import { UserCog, Network, Shield, Cpu, Bot, Zap, CheckCircle2 } from "lucide-react";
...
export default function Page() {
  return (
    <main className="min-h-screen bg-white">
      ...
      <PremiumDigiatureServiceLayout activeService="ai-agent-development">
          ...
          <div className="grid lg:grid-cols-12 gap-12 items-center mb-16">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-black text-slate-900 mb-6 leading-tight">
                Next-Generation <span className="text-blue-600">AI Agent Development</span>
              </h2>
              <p className="text-lg text-slate-600 leading-relaxed mb-6 font-medium">
                WebCodian delivers cutting-edge ai agent development that empower businesses to automate workflows, scale operations, and drive unprecedented growth through artificial intelligence.
              </p>
              ...
              <div className="relative p-6 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-[2rem] border border-white shadow-xl shadow-blue-900/5 group">
                ...
                >
                  <img 
                    ...
                    alt="AI Agent Development Visualization" 
