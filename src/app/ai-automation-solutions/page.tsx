  ...
  return (
    <main>
      <PremiumServiceDetail 
        ...
        overviewTitle="Elevate Your Business with AI & Automation Solutions"
        overviewDescription="Our ai & automation solutions services are designed to give you a competitive edge. We blend innovative strategies with proven methodologies to deliver results that matter."
        features={[
