...
export default function Page() {
  return (
    <main className="min-h-screen bg-white">
      ...
      <PremiumDigiatureServiceLayout activeService="business-automation">
          ...
          <div className="grid lg:grid-cols-12 gap-12 items-center mb-16">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-black text-slate-900 mb-6 leading-tight">
                Next-Generation <span className="text-blue-600">Business Automation</span>
              </h2>
              <p className="text-lg text-slate-600 leading-relaxed mb-6 font-medium">
                WebCodian delivers cutting-edge business automation that empower businesses to automate workflows, scale operations, and drive unprecedented growth through artificial intelligence.
              </p>
