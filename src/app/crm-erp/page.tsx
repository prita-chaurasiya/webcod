  ...
  return (
    <main>
      <PremiumServiceDetail 
        ...
        overviewTitle="Elevate Your Business with CRM & ERP"
        overviewDescription="Our crm & erp services are designed to give you a competitive edge. We blend innovative strategies with proven methodologies to deliver results that matter."
        features={[
