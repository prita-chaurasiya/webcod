  ...
  return (
    <main>
      <PremiumServiceDetail 
        ...
        overviewTitle="Elevate Your Business with Custom Software Development"
        overviewDescription="Our custom software development services are designed to give you a competitive edge. We blend innovative strategies with proven methodologies to deliver results that matter."
        features={[
