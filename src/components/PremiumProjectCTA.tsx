...
export function PremiumProjectCTA() {
  return (
    <section className="py-16 relative overflow-hidden bg-slate-900 perspective-[1000px]">
      ...
      <div className="container mx-auto px-4 lg:px-8 max-w-4xl relative z-10 text-center">
        <motion.div 
          ...
          className="bg-white/10 backdrop-blur-2xl border border-white/20 rounded-[2rem] p-8 md:p-12 shadow-2xl relative overflow-hidden"
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 flex-wrap mt-6">
            <motion.div whileHover={{ y: -4, scale: 1.02 }} whileTap={{ scale: 0.95 }} className="w-full sm:w-auto">
              <Link 
                href="/get-a-quote" 
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-bold rounded-xl shadow-[0_8px_20px_rgba(37,99,235,0.3)] hover:shadow-[0_12px_25px_rgba(37,99,235,0.5)] transition-shadow duration-300 text-base group border border-blue-400/20 relative overflow-hidden"
              >
            ...
            <motion.div whileHover={{ y: -4, scale: 1.02 }} whileTap={{ scale: 0.95 }} className="w-full sm:w-auto">
              <Link 
                href="/contact" 
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 py-3 bg-white text-slate-900 font-extrabold rounded-xl shadow-[0_8px_20px_rgba(255,255,255,0.15)] hover:shadow-[0_12px_25px_rgba(255,255,255,0.3)] transition-shadow duration-300 text-base group"
              >
                <MessageSquare className="w-4 h-4 group-hover:-translate-y-1 transition-transform duration-300 text-blue-600" />
                Contact Us
              </Link>
            </motion.div>
          </div>
