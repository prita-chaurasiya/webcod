          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <div className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-white shadow-sm border border-gray-200">
                ...
                <span className="text-sm font-bold text-gray-700 uppercase tracking-widest">Next-Generation Development</span>
              </div>
      ...
      <section className="py-24 bg-gray-50 border-t border-gray-100">
        <div className="container mx-auto px-4 lg:px-6 max-w-7xl">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-black text-gray-900 mb-4">Our Proven <span className="text-[#2eb872]">Process</span></h2>
